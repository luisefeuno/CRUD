    ...
    <div class="modal" id="modalMostrarPais" tabindex="-1" aria-labelledby="modalMostrarPaisLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header pd-y-20 pd-x-25">
                    <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">País</h6>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body pd-25">
                    <h4 class="lh-3 mg-b-20"><a href="" class="tx-inverse hover-primary">Mantenimiento de paises</a></h4>
                    <p class="mg-b-5">

                    <p><strong>ID:</strong> <span id="idpaises"></span></p>
                    <p><strong>Nombre:</strong> <span id="descrPaises"></span></p>
